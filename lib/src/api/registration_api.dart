...
class RegistrationApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CompleteRegistrationResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<CompleteRegistrationResponse>> completeRegister({ 
    required CompleteRegistrationRequest completeRegistrationRequest,
    ...
    final _path = r'/api/registration/complete';
    ...
    CompleteRegistrationResponse _responseData;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [StartRegistrationResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StartRegistrationResponse>> startRegister({ 
    required StartRegistrationRequest startRegistrationRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/registration/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StartRegistrationResponse _responseData;
