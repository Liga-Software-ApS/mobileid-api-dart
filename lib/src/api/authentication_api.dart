...
class AuthenticationApi {
  ...
  Future<Response<AuthenticationResponse>> authenticate({ 
    ...
    final _path = r'/api/authentication/';
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CheckAuthenticationResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<CheckAuthenticationResponse>> check({ 
    required CheckAuthenticationRequest checkAuthenticationRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/authentication/get';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    CheckAuthenticationResponse _responseData;
